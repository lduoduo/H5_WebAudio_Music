...
MusicVisualizer.prototype.ini = function(i, t, e) {
    ...
    this.volumnId.onclick = function() {
        o.changeVolumn(this.value / this.max)
    }
}
,
...
MusicVisualizer.prototype.decode = function(i, t) {
    var e = this;
    MusicVisualizer.ac.decodeAudioData(t, function(t) {
        e.playBuffer(i, t)
    }, function(i) {
        console.log("err:" + i)
    })
...
MusicVisualizer.prototype.playBuffer = function(i, t) {
    ...
    e.source.curr = i;
    var o = MusicVisualizer.ac.createBufferSource();
    o.buffer = t,
    o.loop = !0,
...
,
MusicVisualizer.stop1 = function(i) {
    i.source === i.audioSource ? (i.audio.pause(),
    i.audio.onended = window.undefined) : (i.source[i.source.stop ? "stop" : "noteOff"](0),
    i.source.onended = window.undefined)
}
,
